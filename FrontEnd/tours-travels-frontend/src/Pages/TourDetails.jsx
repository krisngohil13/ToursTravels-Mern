...
const TourDetails = () => {
  ...
  if (errorTour || errorReviews) {
    return <div className="error__msg">Error loading details. Please check your network connection.</div>;
  }
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const reviewUrl = `${BASE_URL.replace(/\/+$/, '')}/review/${id}`;
